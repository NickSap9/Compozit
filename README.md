...
2)	Провести разведочный анализ предложенных данных. Необходимо сделать таблицы распределения каждой из переменной, таблицы ящика с усами, попарные таблицы рассеяния точек. Необходимо также для каждой колонке получить среднее, медианное значение, провести анализ и исключение выбросов, проверить наличие пропусков.
